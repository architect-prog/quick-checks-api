...
public interface IParsedQuestionOptionMapper :
    IMapper<ParsedQuestionOptionDto, QuestionOptionResponseDto>,
    IMapper<QuestionOptionRequestDto, ParsedQuestionOptionDto>
{
}